...
export type UnsignedInt = {
    readonly [__uint]: never;
};
export type Bits8 = {
    readonly [__bits8]: never;
};
export type Bits16 = {
    readonly [__bits16]: never;
};
export type Bits32 = {
    readonly [__bits32]: never;
};
export type Bits64 = {
    readonly [__bits64]: never;
};
export type Bits128 = {
    readonly [__bits128]: never;
};
export type Bits160 = {
    readonly [__bits160]: never;
};
export type Bits256 = {
    readonly [__bits256]: never;
};
export type ByteLen1 = {
    readonly [__bytes1]: never;
};
export type ByteLen2 = {
    readonly [__bytes2]: never;
};
export type ByteLen4 = {
    readonly [__bytes4]: never;
};
export type ByteLen8 = {
    readonly [__bytes8]: never;
};
export type ByteLen20 = {
    readonly [__bytes20]: never;
};
export type ByteLen21 = {
    readonly [__bytes21]: never;
};
export type ByteLen32 = {
    readonly [__bytes32]: never;
};
export type ByteLen65 = {
    readonly [__bytes65]: never;
};
/**
...
export type ValueTypeMap = Prettify<UintValueTypeMap & Readonly<{
    bool: boolean;
    address: Address;
}>>;
export type UintValueTypeBitsMap = Prettify<Omit<UintBitsMap, "uint160">>;
export type ValueTypeBitsMap = Prettify<UintValueTypeBitsMap & Readonly<{
    bool: 1;
    address: 160;
}>>;
