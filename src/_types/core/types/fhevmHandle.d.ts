...
import type { Bytes21Hex, Bytes32, Bytes32Hex, Bytes32HexAble, Bytes32HexNo0x, Uint64BigInt, Uint8Number } from "./primitives.js";
declare const __fhevmHandle: unique symbol;
export type FhevmHandleBrand = {
    readonly [__fhevmHandle]: never;
};
