...
export type UnverifiedInputProof = Prettify<Omit<InputProof, "coprocessorSignedParams" | "verified"> & {
    readonly verified: false;
    readonly coprocessorSignedParams: undefined;
}>;
export type VerifiedInputProof = Prettify<Omit<InputProof, "coprocessorSignedParams" | "verified"> & {
...
//# sourceMappingURL=inputProof.d.ts.map