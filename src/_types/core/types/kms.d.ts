import type { Bytes32Hex, BytesHex, ChecksummedAddress, Uint64BigInt, Uint8Number } from "./primitives.js";
import type { Prettify } from "./utils.js";
export declare const kmsBrand: unique symbol;
export type Kms = {
    readonly [kmsBrand]: never;
};
...
export type KmsDelegateUserDecryptEIP712Types = {
    ...
    readonly DelegatedUserDecryptRequestVerification: readonly [
        ...
        {
            readonly name: "delegatedAccount";
            readonly type: "address";
        }
    ];
};
...
export type KmsDelegatedUserDecryptEIP712Message = Prettify<KmsUserDecryptEIP712Message & {
...
export type KmsPublicDecryptEIP712 = Readonly<Prettify<{
