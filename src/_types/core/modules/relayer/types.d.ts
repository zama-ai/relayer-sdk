...
import type { GlobalFhePkeParamsBytes, GlobalFhePkeParamsSource } from "../../types/globalFhePkeParams.js";
...
export type FetchGlobalFhePkeParamsSourceModuleFunction = {
    fetchGlobalFhePkeParamsSource(relayerClient: RelayerClient, parameters: FetchGlobalFhePkeParamsSourceParameters): Promise<FetchGlobalFhePkeParamsSourceReturnType>;
};
...
export type FetchGlobalFhePkeParamsBytesModuleFunction = {
    fetchGlobalFhePkeParamsBytes(relayerClient: RelayerClient, parameters: FetchGlobalFhePkeParamsBytesParameters): Promise<FetchGlobalFhePkeParamsBytesReturnType>;
};
...
export type FetchCoprocessorSignaturesModuleFunction = {
    fetchCoprocessorSignatures(relayerClient: RelayerClient, parameters: FetchCoprocessorSignaturesParameters): Promise<FetchCoprocessorSignaturesReturnType>;
};
...
export type FetchPublicDecryptModuleFunction = {
    fetchPublicDecrypt(relayerClient: RelayerClient, parameters: FetchPublicDecryptParameters): Promise<FetchPublicDecryptReturnType>;
};
...
export type FetchUserDecryptModuleFunction = {
    fetchUserDecrypt(relayerClient: RelayerClient, parameters: FetchUserDecryptParameters): Promise<FetchUserDecryptReturnType>;
};
...
export type FetchDelegatedUserDecryptModuleFunction = {
    fetchDelegatedUserDecrypt(relayerClient: RelayerClient, parameters: FetchDelegatedUserDecryptParameters): Promise<FetchDelegatedUserDecryptReturnType>;
};
export type RelayerModule = Prettify<FetchGlobalFhePkeParamsSourceModuleFunction & FetchGlobalFhePkeParamsBytesModuleFunction & FetchCoprocessorSignaturesModuleFunction & FetchUserDecryptModuleFunction & FetchPublicDecryptModuleFunction & FetchDelegatedUserDecryptModuleFunction>;
