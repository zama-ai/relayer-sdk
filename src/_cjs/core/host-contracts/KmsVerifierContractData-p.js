...
exports.createKmsVerifierContractData = createKmsVerifierContractData;
exports.assertKmsVerifierContractDataOwnedBy = assertKmsVerifierContractDataOwnedBy;
...
function createKmsVerifierContractData(owner, parameters) {
    return new KmsVerifierContractDataImpl(PRIVATE_TOKEN, owner, parameters);
}
function assertKmsVerifierContractDataOwnedBy(data, owner) {
