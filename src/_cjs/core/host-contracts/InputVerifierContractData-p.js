...
exports.createInputVerifierContractData = createInputVerifierContractData;
exports.assertInputVerifierContractDataOwnedBy = assertInputVerifierContractDataOwnedBy;
...
function createInputVerifierContractData(owner, parameters) {
    return new InputVerifierContractDataImpl(PRIVATE_TOKEN, owner, parameters);
}
function assertInputVerifierContractDataOwnedBy(data, owner) {
