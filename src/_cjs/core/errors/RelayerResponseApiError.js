...
exports.RelayerResponseApiError = void 0;
...
class RelayerResponseApiError extends RelayerResponseErrorBase_js_1.RelayerResponseErrorBase {
    constructor(params) {
        const metaMessages = [
        ...
        super({
            ...
            message: `${(0, RelayerErrorBase_js_1.humanReadableOperation)(params.operation, true)}: Relayer API error [${params.relayerApiError.label}]: ${params.relayerApiError.message}`,
        });
...
exports.RelayerResponseApiError = RelayerResponseApiError;
