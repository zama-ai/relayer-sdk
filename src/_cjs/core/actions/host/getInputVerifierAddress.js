...
exports.getInputVerifierAddress = getInputVerifierAddress;
...
async function getInputVerifierAddress(fhevm, parameters) {
    ...
    const res = await fhevm.runtime.ethereum.readContract(trustedClient, {
        address: address,
        abi: fragments_js_1.getInputVerifierAddressAbi,
        args: [],
        functionName: fragments_js_1.getInputVerifierAddressAbi[0].name,
    });
    try {
