...
exports.getFHEVMExecutorAddress = getFHEVMExecutorAddress;
...
async function getFHEVMExecutorAddress(fhevm, parameters) {
    ...
    const res = await fhevm.runtime.ethereum.readContract(trustedClient, {
        address: address,
        abi: fragments_js_1.getFHEVMExecutorAddressAbi,
        args: [],
        functionName: fragments_js_1.getFHEVMExecutorAddressAbi[0].name,
    });
    try {
