...
exports.getHandleVersion = getHandleVersion;
...
async function getHandleVersion(fhevm, parameters) {
    ...
    const res = await fhevm.runtime.ethereum.readContract(trustedClient, {
        address: address,
        abi: fragments_js_1.getHandleVersionAbi,
        args: [],
        functionName: fragments_js_1.getHandleVersionAbi[0].name,
    });
