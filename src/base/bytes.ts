...
import { isUintForByteLength } from './uint';
...
export function isBytesForType<T extends BytesXXTypeName>(
  value: unknown,
  typeName?: T,
...
export function assertIsBytesForType(
  value: unknown,
  options?: {
    typeName: BytesXXTypeName;
    subject?: string;
  } & ErrorMetadataParams,
): asserts value is Bytes {
 ...
 */
export function unsafeBytesEquals(a: Bytes, b: Bytes): boolean {
