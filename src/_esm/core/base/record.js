 ...
 * ```
 */
export function isRecordNonNullableProperty(o, property) {
    if (o === undefined ||
        o === null ||
        typeof o !== "object" ||
        !(property in o) ||
 ...
 * ```
 */
export function assertRecordNonNullableProperty(record, property, recordName, options) {
 ...
 * ```
 */
export function isRecordArrayProperty(record, property) {
    if (!isRecordNonNullableProperty(record, property)) {
        return false;
    }
 ...
 * ```
 */
export function assertRecordArrayProperty(record, property, recordName, options) {
...
////////////////////////////////////////////////////////////////////////////////
export function isRecordBooleanProperty(record, property) {
    if (!isRecordNonNullableProperty(record, property)) {
        return false;
    }
    return typeof record[property] === "boolean";
}
export function assertRecordBooleanProperty(record, property, recordName, options) {
...
////////////////////////////////////////////////////////////////////////////////
export function typeofProperty(o, property) {
