 ...
 */
export function setFhevmRuntimeConfig(config) {
...
////////////////////////////////////////////////////////////////////////////////
export function getEthersRuntime() {
    if (globalFhevmRuntimeConfig === undefined) {
 ...
 */
export function ethersContractRunnerToTrustedClient(runner) {
 ...
 */
export function trustedClientToEthersContractRunner(trustedClient) {
    return verifyTrustedValue(trustedClient, PRIVATE_ETHERS_TOKEN);
}
export function createFhevmRuntime(parameters) {
