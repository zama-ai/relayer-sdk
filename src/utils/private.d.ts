import type { Uint, ChecksummedAddress, Uint256 } from '../types/primitives';
...
export type RecordStringArrayPropertyType<K extends string> =
  RecordWithPropertyType<K, Array<string>>;
...
export type RecordChecksummedAddressArrayPropertyType<K extends string> =
  RecordWithPropertyType<K, Array<ChecksummedAddress>>;
