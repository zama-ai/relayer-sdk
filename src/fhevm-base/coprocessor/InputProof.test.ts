...
import type { InputProof } from '../types/public-api';
...
// Jest Command line
// =================
// npx jest --colors --passWithNoTests ./src/fhevm-base/coprocessor/InputProof.test.ts
//
////////////////////////////////////////////////////////////////////////////////
...
describe('InputProof', () => {
  ...
  describe('getters', () => {
    ...
    it('signatures returns Bytes65Hex array', () => {
      expect(Array.isArray(inputProof.coprocessorSignatures)).toBe(true);
      expect(inputProof.coprocessorSignatures).toEqual([
        VALID_SIGNATURE_1,
        VALID_SIGNATURE_2,
      ]);
  ...
  describe('immutability', () => {
    ...
    it('signatures array is frozen', () => {
      ...
      expect(Object.isFrozen(inputProof.coprocessorSignatures)).toBe(true);
    });
