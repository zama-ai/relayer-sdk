...
import { toFhevmHandle } from '../FhevmHandle';
...
// =================
//
// npx jest --colors --passWithNoTests ./src/fhevm-base/ACL.test.ts
// npx jest --colors --passWithNoTests ./src/fhevm-base/ACL.test.ts --testNamePattern=xxx
// npx jest --colors --passWithNoTests --coverage ./fhevm-base/sdk/ACL.test.ts --collectCoverageFrom='./src/fhevm-base/ACL.ts'
//
////////////////////////////////////////////////////////////////////////////////
...
describe('ACL', () => {
  ...
  describe('constructor', () => {
    ...
    it('throws ChecksummedAddressError for invalid address', () => {
      const client = createClient(fhevmLibs, createMockProvider(), '0xinvalid');
      expect(() => createACL(client)).toThrow(ChecksummedAddressError);
    });
  ...
  describe('isAllowedForDecryption', () => {
    ...
    it('accepts FhevmHandle instance', async () => {
      ...
      const handle = toFhevmHandle(VALID_HANDLE_HEX);
    ...
    it('accepts array with FhevmHandle instances', async () => {
      ...
      const handle1 = toFhevmHandle(VALID_HANDLE_HEX);
