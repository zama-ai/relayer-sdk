...
import { assertKmsEIP712DomainType } from './guards';
...
// Jest Command line
// =================
// npx jest --colors --passWithNoTests ./src/sdk/kms/guards.test.ts
//
////////////////////////////////////////////////////////////////////////////////
...
describe('assertKmsEIP712DomainType', () => {
  //////////////////////////////////////////////////////////////////////////////
  // Valid inputs
  //////////////////////////////////////////////////////////////////////////////
  ...
  describe('valid inputs', () => {
    it('accepts valid domain object', () => {
      ...
      expect(() => assertKmsEIP712DomainType(domain, 'domain')).not.toThrow();
    });
  ...
  describe('invalid name property', () => {
    it('throws for missing name property', () => {
      ...
      expect(() => assertKmsEIP712DomainType(domain, 'domain')).toThrow(
  ...
  describe('edge cases', () => {
    ...
    it.each(invalidInputs)('throws for %s input', (_name, input) => {
      expect(() => assertKmsEIP712DomainType(input, 'domain')).toThrow(
        InvalidPropertyError,
      );
    });
  });
  ...
  describe('error messages', () => {
    it('error includes the provided object name', () => {
      ...
      expect(() => assertKmsEIP712DomainType(domain, 'myCustomDomain')).toThrow(
        /myCustomDomain/,
      );
    });
  });
