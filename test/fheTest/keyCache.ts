...
function keyPath(chain: FheTestChain): string {
  return resolve(KEYS_DIR, chain, "key.json");
}

////////////////////////////////////////////////////////////////////////////////

export function hasKeyInCache(chain: FheTestChain): boolean {
...
export function clearKeyCache(chain?: FheTestChain): void {
  if (chain !== undefined) {
    const dir = resolve(KEYS_DIR, chain);
    if (existsSync(dir)) {
